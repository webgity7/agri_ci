...
ob_end_flush();
// echo "<pre>";
$title = $title = "AgriExpress | Billing Page";
// var_dump($_SESSION);
...
<div id="main-container">
    <div class="container" style="margin-bottom:6px;">
        ...
        <div id="content" style="min-height: 300px;">
            <div class="" style="display: flex;  flex-wrap:wrap; gap:6px; ">
                            ...
                            <div class=" ">
                                ...
                                <div style="display: flex; justify-content:center; align-items:center;">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" name="address" value="<?= $result->result[$data]['address_id'] ?>" id="checkbox <?= $data ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" name="billingAdd" action="submit_billing.php" enctype="multipart/form-data">
...
<script>
    // Dynamically check checkbox state
    const checkboxes = document.querySelectorAll('input[type="checkbox"][name="address"]');
    ...
    conButton.addEventListener('click', (e) => {
        console.log(`manage.php?type=billing&clientId=${clientId}&address=${addressId}`);
        window.location = `manage.php?type=billing&clientId=${clientId}&address=${addressId}`
    })
</script>
