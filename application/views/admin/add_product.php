        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline mb-4">
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form id="image_form" action="submit" method="post" enctype="multipart/form-data">
...
<script>
    ...
    const render = () => {
        ...
        files.forEach((f, i) => {
            ...
            box.innerHTML = `<img src="${URL.createObjectURL(f)}" style="width:120px;height:120px;object-fit:cover;border:1px solid #ccc;border-radius:6px;box-shadow:0 2px 5px rgba(0,0,0,.1)">
...
<script>
document.getElementById('image_form').addEventListener('submit', e => {
  const form = e.target;
  const name = form.product_name.value.trim();
  const category = form.category.value;
  const price = form.product_price.value;
  const image = form.featured_image.files[0];
  ...
  // If any field is missing, prevent submission and show alert
