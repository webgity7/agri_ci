        ...
        <div class="row">
            ...
            <aside class="col-sm-3 hidden-xs" id="column-left">
                ...
                <ul class="category-list">
                    ...
                    ?>
                    <li class="<?= $li_classes ?>">
                        <a href="<?= base_url('category?cid=' . $cat['id']) ?>" class="<?= $isActiveCategory ? 'active' : '' ?>">
                        ...
                        <ul style="display: <?= $isActiveCategory ? 'block' : 'none' ?>;">
                            ...
                            <li>
                                <a href="<?= base_url('category?cid=' . $cat['id'] . '&sid=' . $sub['id']) ?>"
                ...
                <div class="search-bar">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-5 text-right">
                            <select onchange="updateQueryParam('sort', this.value)" class="form-control">
                        ...
                        <div class="col-md-2 col-sm-2 text-right">
                            <select onchange="updateQueryParam('limit', this.value)" class="form-control">
...
<style>
.category-list a.active { font-weight: bold; color: #007bff; }
.category-list a.active-sub { text-decoration: underline; color: #dc3545; }
.category-list li.active-category>a { font-weight: bold; color: #28a745; }
</style>
